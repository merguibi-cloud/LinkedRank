...
export default function Signup() {
  ...
  const redirect = useMemo(() => {
    ...
    return sanitizeInternalRedirect(params.get("redirect"));
  }, []);
  ...
  }, [user, loading, redirect, setLocation, utils]);
  ...
  const goToOnboarding = async () => {
    ...
    window.location.href = await resolvePostAuthRedirect(redirect, utils);
  };
        ...
        {step === 1 ? (
          ...
          >
            <div className="mb-6">
              ...
              <p className="text-muted-foreground mt-2">
                Inscription → profil → LinkedIn → votre premier post
              </p>
            </div>
          ...
          >
            ...
            <div className="mb-6">
              ...
              <p className="text-muted-foreground mt-2">
                Ensuite, quelques questions pour personnaliser votre contenu
              </p>
            </div>
